...
public class MainActivity extends ListActivity
{
   ...
   private RadioButton raAll;
   private RadioButton raImages;
   private RadioButton raVideos;
   private RadioButton raLinks;
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      getListView().setOnItemLongClickListener(itemLongClickListener);  
       ...
       filterGroup = (RadioGroup) findViewById(R.id.raFilter);
      
      filterGroup.clearCheck();
      filterGroup.setOnCheckedChangeListener(FilterChanged);
      
      raAll = (RadioButton)findViewById(R.id.raAll);
      raImages = (RadioButton)findViewById(R.id.raImages);
      raLinks = (RadioButton)findViewById(R.id.raLinks);
      raVideos = (RadioButton)findViewById(R.id.raVideos);
   ...
   private OnCheckedChangeListener FilterChanged =
		   new OnCheckedChangeListener()
   {
	   ...
	   public void onCheckedChanged(RadioGroup group, int checkedID){
		   ...
		   if (checkedID == R.id.raAll)
			   strFilter = "";
		   
		   if (checkedID == R.id.raImages)
			   strFilter = "filter:images"; 
		   
		   
		   
		   
		   if (checkedID == R.id.raLinks)
			   strFilter = "filter:links"; 
		   
		   
		   if (checkedID == R.id.raVideos)
			   strFilter = "filter:video";
		  ...
		  if (!anotherQ.contains("filter:")) 
			  anotherQ += (" " + strFilter);
		   
		
		   queryEditText.setText(anotherQ);
                  ...
                  public void onClick(DialogInterface dialog, int which)
                  {
                     switch (which)
                     {
                        ...
                        case 1: // edit
                           ...
                           String q = savedSearches.getString(tag, "");
                           
                           queryEditText.setText(q);
                           ...
                           if (q.contains("filter:images"))
                        	   raImages.setChecked(true);
                           
                           if (q.contains("filter:links"))
                        	   raLinks.setChecked(true);
                           
                           if (q.contains("filter:video"))
                        	   raVideos.setChecked(true);
